...
/*****	Definitions	*****/
	...
	*/
	typedef struct sSQLRecordSet_t {
		MYSQL_RES *dbRecordSet;	/**< Recordset object for the database connector */
		sSQLRecord_t Record;	/**< Currently loaded record of data from the recordset */
		uint32_t nIndex;		/**< Index number of this open recordset */
		sSQLRecordSet_t *pRSNext;	/**< Pointer to the next open recordset */
	} sSQLRecordSet_t;
