...
/*****	Prototypes 	*****/
	...
	bool RasPiDelaySeconds(uint32_t nDelayAmount);
	
	bool RasPiDelayMilliSeconds(uint32_t nDelayAmount);
	
	bool RasPiDelayMicroSeconds(uint32_t nDelayAmount);
...
bool RasPiTimeInit(sTimeIface_t *pTime) {
