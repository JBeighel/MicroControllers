...
/***** Definitions	*****/
	...
	enum eRFM69HCW_Reg_OpMode_t {
		LORA_OpMode_SeqOff		= 0x80,	/**< Controls automatic sequencer: 0 operating mode as selected with mode bits, 1 mode is forced by user */
		LORA_OpMode_ListenOn	= 0x40,	/**< Enables listen mode: 0 off, 1 on */
		LORA_OpMode_ListenAbort	= 0x20,	/**< Aborts listen mode: always reads 0, write 1 to abort listen */
		
		LORA_OpMode_ModeMask	= 0x1C,	/**< Mask for all bits used in setting the operating mode */
		LORA_OpMode_ModeSleep	= 0x00,	/**< Sleep mode */
		LORA_OpMode_ModeStandBy	= 0x04,	/**< Standby mode */
		LORA_OpMode_ModeFreqSyn	= 0x08,	/**< Frequency synthesis mode */
		LORA_OpMode_ModeTx		= 0x0C, /**< Transmitter mode */
		LORA_OpMide_ModeRx		= 0x10,	/**< Receiver mode */
	};
